...
class Drive extends Auth {
  constructor(drivePath, publicKey, { keyPair, ignore, seed, watch }) {
    super();
    ...
    this.watch = typeof watch !== 'undefined' ? watch : DEFAULT_OPTS.watch; // If true watch for updates to local drive and write those updates to the DB
