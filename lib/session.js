 ...
 * 
 * 
 * NOTE: THIS CLASS IS BEING DEPRECATED
 * 
 * 
 */
...
class HyperSession {
  ...
  async add(sessionName, opts) {
    ...
    if (!session.CoreMap.Drives) session.CoreMap.Drives = {};
    if (!session.CoreMap.Cores) session.CoreMap.Cores = {};
  ...
  async addDrive(name, opts) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      session.CoreMap.Drives[name] = hyperdrive;
  ...
  destroyStorage(opts) {
    ...
    const resource = opts.type === 'hyperdrive' ? session.CoreMap.Drives[opts.name] : session.CoreMap.Cores[opts.name];
  ...
  addCore(name, opts) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      session.CoreMap.Cores[name] = hypercore;
